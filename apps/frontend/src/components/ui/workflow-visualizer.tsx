    ...
    <div className="relative flex items-center">
      ...
      >
        <CardHeader className="pb-3">
          ...
          <div className="flex items-center justify-between">
            <Badge
              variant={statusBadgeVariants[step.status]}
              className="text-xs"
            >
              {step.status}
            </Badge>
...
function VerticalWorkflowStepCard({
  step,
  isLast,
}: {
  step: WorkflowStep;
        ...
        <div className="flex flex-col items-center">
          <div
            className={cn(
              ...
              step.status === 'running' &&
                'bg-blue-100 border-blue-500 text-blue-500 animate-pulse',
              step.status === 'failed' &&
          ...
          {!isLast && <div className="h-12 w-0.5 bg-border mt-2" />}
        </div>
